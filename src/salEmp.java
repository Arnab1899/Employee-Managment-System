...
public class salEmp implements Serializable 
{
	salEmp()
	{
        ...
        add.setOnAction(new EventHandler<ActionEvent>() 
        {
			...
			{
				Main.emp.addNewEmployee(tf1.getText(),tf2.getText(),tf3.getText(),Double.parseDouble(tf4.getText()) );		
        ...
        layout.getChildren().addAll(l1,tf1,l2,tf2,l3,tf3,l4,tf4,add);
        Scene SecondScene = new Scene(layout, 500, 500);
        Stage newWindow = new Stage();
        
        newWindow.setTitle("Enter Salaried Employee Information");
